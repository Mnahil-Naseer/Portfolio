...
export default function Resume() {
  return (
    <section id="resume" className="relative py-28 sm:py-36 bg-base-900/40">
      <div className="max-w-6xl mx-auto px-6 flex flex-col gap-14">
        ...
        <div className="flex flex-wrap gap-4">
          <Button as="a" href="/Mnahil_Naseer_Resume.pdf" variant="primary" download>
            Download Resume (PDF)
          </Button>
          <Button
            as="a"
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {infoCards.map((card, i) => (
            ...
            >
              <h4 className="font-mono text-xs uppercase tracking-wider text-violet-400">{card.title}</h4>
              {card.lines.map((line) => (
